...
static void SSD1309UpdateScreenHOR(SPI_HandleTypeDef *hspi, uint8_t screen[static 128]);
static void SSD1309UpdateScreenVER(SPI_HandleTypeDef *hspi, uint8_t screen[static 128]);
static void SSD1309UpdateScreenPAGE(SPI_HandleTypeDef *hspi, uint8_t screen[static 128]);
